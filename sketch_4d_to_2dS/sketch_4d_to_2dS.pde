float angle = 0;
float diag = 0;
P4Vector[] points = new P4Vector[5];
...
void setup() {
  ...
  points[2] = new P4Vector(   0,   0.5,  -0.5,  0.5);
  points[3] = new P4Vector(   0,     0,   0.5,  0.5);
  points[4] = new P4Vector(   0,     0,   0.5, -0.5);
}
...
void draw() {
  ...
  PVector[] projected = new PVector[5];
  int index = 0;
  ...
  for(P4Vector v : points) {
    ...
    //ellipse(newp.x, newp.y, newp.z, 3);
  }
  ...
  connect(0, 0, 1, projected);
  connect(0, 0, 2, projected);
  connect(0, 1, 2, projected);
  connect(0, 0, 3, projected);
  connect(0, 1, 3, projected);
  connect(0, 2, 3, projected);
  connect(0, 0, 4, projected);
  connect(0, 1, 4, projected);
  connect(0, 2, 4, projected);
  connect(0, 3, 4, projected);
